...
list = glob.glob('images/test/cats/*.jpg')
for i in(list):
    ...
    # print(str(labelp) + "cccccccccccccccccccccccccccccccc")
    if labelp == 'cat':
        num = num+1
    
list1 = glob.glob('images/test/dogs/*.jpg')
for j in(list1):
    image1 = load_img(j)
    ...
    # print(str(labelp)+"ddddddddddddddddddddddddddddddddddd")
    if labelp == 'dog':
        num = num+1
# print(num)
# print(len(list))
